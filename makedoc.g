###########################################################################
##
#W    buildman.g             MapClass Package           Alexander Konovalov
##                                                      
###########################################################################
...
##  MAPCLASSBuildManual()
##
MAPCLASSBuildManual:=function()
local mypath, path, main, files, f, bookname;
path:="doc";
main:="mapclass.xml";
bookname:="mapclass";
MakeGAPDocDoc( path, main, MAPCLASSMANUALFILES, bookname, "../../..", "MathJax" );  
CopyHTMLStyleFiles( path );
GAPDocManualLab( "mapclass" );; 
ExtractMyManualExamples( "mapclass", main, MAPCLASSMANUALFILES);
end;
